    ...
    <PageSlide tabIndex={3}>
      <SafeAreaView style={styles.container} edges={['top']}>
        <ScrollView contentContainerStyle={styles.scrollContent} showsVerticalScrollIndicator={false}>
          ...
          {editingProfile && (
            <PremiumCard>
              <SectionTitle title="Editar Perfil" subtitle="Atualize seus dados" />
              <View style={{ gap: 14 }}>
          ...
          <PremiumCard>
            <View style={styles.metricsContainer}>
              ...
              <View style={styles.metricDivider} />
              <MetricRow label="Objetivo" value={userProfile?.goal?.replace('_', ' ') || '—'} />
              <View style={styles.metricDivider} />
            ...
            <View style={{ gap: 12 }}>
              <TouchableOpacity style={styles.settingItem} onPress={handleNotifications}>
                <View style={styles.settingIcon}>
                  <MaterialIcons name="notifications" size={24} color={COLORS.GreenPrimary} />
                </View>
              ...
              <TouchableOpacity style={styles.settingItem} onPress={handleEditProfile}>
                <View style={styles.settingIcon}>
                  <MaterialIcons name="edit" size={24} color={COLORS.GreenPrimary} />
                </View>
              ...
              <TouchableOpacity style={styles.settingItem} onPress={handleSecurity}>
                <View style={styles.settingIcon}>
                  <MaterialIcons name="security" size={24} color={COLORS.GreenPrimary} />
                </View>
              ...
              <TouchableOpacity style={styles.settingItem} onPress={handleHelpSupport}>
                <View style={styles.settingIcon}>
                  <MaterialIcons name="help" size={24} color={COLORS.GreenPrimary} />
                </View>
          ...
          {showNotificationPreferences && (
            <PremiumCard>
              <Text style={styles.modalTitle}>Preferências de Notificação</Text>
